 ...
 * @returns {Promise<any>}
 */
module.exports.classify = function(subject, body) {
    ...
    const ret = wasm.classify(ptr0, len0, ptr1, len1);
    return ret;
};
...
module.exports.__wbindgen_closure_wrapper44 = function(arg0, arg1, arg2) {
...
const path = require('path').join(__dirname, 'wasm_host_bg.wasm');
